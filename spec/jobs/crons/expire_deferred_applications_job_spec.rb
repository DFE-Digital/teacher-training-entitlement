...
RSpec.describe Crons::ExpireDeferredApplicationsJob do
  ...
  describe "#perform" do
    ...
    context "when application has been deferred for more than 14 months" do
      before do
        application.application_events.find_by(event: "StateChange::Application::DEFERRED").update!(created_at: 15.months.ago)
      end
    ...
    context "when application has been deferred for less than 14 months" do
      before do
        application.application_events.find_by(event: "StateChange::Application::DEFERRED").update!(created_at: 13.months.ago)
      end
    ...
    context "when application was deferred, resumed, then deferred again recently" do
      ...
      before do
        ...
        application.application_events.create!(event: "StateChange::Application::DEFERRED", created_at: 16.months.ago)
        # Resumed
        application.application_events.create!(event: "StateChange::Application::STARTED", created_at: 10.months.ago)
        # Second deferral 2 months ago
        application.application_events.create!(event: "StateChange::Application::DEFERRED", created_at: 2.months.ago)
