...
RSpec.describe Admin::Finance::Statements::PaymentAuthorisationsController, type: :request do
  ...
  context "when logged in" do
    ...
    describe "#new" do
      before { get new_admin_finance_payment_authorisation_path(statement) }
    ...
    describe "#create" do
      before { post admin_finance_payment_authorisation_path(statement, params:) }
  ...
  context "when not logged in" do
    ...
    describe "#create" do
      before do
        post admin_finance_payment_authorisation_path(statement, params: {})
      end
