...
RSpec.describe Admin::CourseCohortLeadProvidersController, type: :request do
  ...
  context "when logged in as super admin" do
    ...
    describe "#show" do
      before { get admin_course_course_cohort_lead_provider_path(course, course_cohort) }
    ...
    describe "#update" do
      ...
      it "updates the providers for the course cohort" do
        patch admin_course_course_cohort_lead_provider_path(course, course_cohort),
              params: {
