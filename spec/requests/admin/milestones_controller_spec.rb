...
RSpec.describe Admin::MilestonesController, :revisit, type: :request do
  ...
  context "when logged in as super admin" do
    ...
    describe "#new" do
      context "when the schedule has limited declaration types available" do
        ...
        before { get new_admin_cohort_schedule_milestone_path(cohort, schedule) }
    ...
    describe "#create" do
      context "when no declaration type is chosen" do
        ...
        before { post admin_cohort_schedule_milestones_path(cohort, schedule), params: }
    ...
    describe "#update" do
      context "when no statement date is chosen" do
        ...
        before { put admin_cohort_schedule_milestone_path(cohort, schedule, milestone), params: }
    ...
    describe "#destroy" do
      context "when a milestone has already been deleted" do
        before do
          ...
          milestone.destroy!
          delete admin_cohort_schedule_milestone_path(cohort, schedule, milestone_id), params: { confirm: "1" }
        end
  ...
  context "when logged in as normal admin" do
    ...
    describe "#edit" do
      before { get edit_admin_cohort_schedule_milestone_path(cohort, schedule, milestone) }
    ...
    describe "#destroy" do
      before { delete admin_cohort_schedule_milestone_path(cohort, schedule, milestone) }
