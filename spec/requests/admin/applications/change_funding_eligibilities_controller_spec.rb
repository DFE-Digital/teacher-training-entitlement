...
RSpec.describe Admin::Applications::ChangeFundingEligibilitiesController, :ecf_api_disabled, type: :request do
  ...
  context "when logged in" do
    ...
    describe "#new" do
      before do
        get new_admin_applications_change_funding_eligibility_path(application)
      end
  ...
  context "when not logged in" do
    describe "#new" do
      before { get new_admin_applications_change_funding_eligibility_path(application) }
