...
RSpec.feature "Happy journeys", :with_default_schedules, :with_default_school, type: :feature do
  ...
  def run_scenario(js:)
    ...
    deep_compare_application_data(
      ...
      "institution_id" => School.find_by(urn: "100000").institution.id,
      ...
      "training_status" => nil,
      "ukprn" => School.find_by(urn: "100000").ukprn,
      ...
      "raw_application_data" => {
        ...
        "institution_id" => School.find_by(urn: 100_000).institution.id.to_s,
