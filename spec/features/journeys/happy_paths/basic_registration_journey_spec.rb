...
RSpec.feature "Happy journeys", :with_default_schedules, :with_default_school, type: :feature do
  ...
  def run_scenario(js:)
    ...
    deep_compare_application_data(
      ...
      "training_status" => nil,
      "ukprn" => Institution.find_by(institution_reference_number: "100000").institutionable.ukprn,
      ...
      "raw_application_data" => {
        ...
        "institution_id" => Institution.find_by(institution_reference_number: "100000").institutionable.institution.id.to_s,
