  ...
  describe "#call" do
    ...
    context "when running in sandbox environment" do
      ...
      describe "successful seeding" do
        ...
        it "creates cohorts for the course" do
          seeder.call
          ...
          expect(primary_cohort.course).to eq(course)
          expect(secondary_cohort.course).to eq(course)
        end
      ...
      describe "idempotency (running twice)" do
        ...
        it "does not delete users with other applications" do
          ...
          user = User.find_by(ecf_id: seeder.test_user_ecf_ids.first)
