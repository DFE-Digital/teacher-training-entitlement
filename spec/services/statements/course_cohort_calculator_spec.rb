...
RSpec.describe Statements::CourseCohortCalculator do
  ...
  let(:started_milestone) { create(:milestone, :started, payment_percentage: 60) }
  ...
  let!(:completed_milestone) { create(:milestone, :completed, course_cohort:, payment_percentage: 40, acceptance_window_start_date: 2.months.from_now) }
  ...
  describe "with started and completed declarations" do
    ...
    let!(:completed_milestone) { create(:milestone, :completed, course_cohort:, payment_percentage: 40, acceptance_window_start_date: 1.day.ago) }
