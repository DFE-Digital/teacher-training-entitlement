...
RSpec.describe Statements::CourseCohortCalculator do
  ...
  let(:started_milestone) { create(:milestone, :started, course: course_cohort.course, payment_amount: 60, acceptance_window_start_offset: 0, acceptance_window_end_offset: 14) }
  let!(:completed_milestone) { create(:milestone, :completed, course: course_cohort.course, payment_amount: 40, acceptance_window_start_offset: 60, acceptance_window_end_offset: 90) }
  ...
  describe "with started and completed declarations" do
    ...
    let!(:completed_milestone) { create(:milestone, :completed, course: course_cohort.course, payment_amount: 40, acceptance_window_start_offset: 0, acceptance_window_end_offset: 14) }
