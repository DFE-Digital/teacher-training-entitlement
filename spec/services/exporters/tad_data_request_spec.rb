  ...
  describe "#call" do
    let(:csv) do
      <<~CSV
        ...
        John Doe,john@example.com,#{user.id},#{user.trn},#{application.school.urn},#{application.lead_provider.name},NPQ Senior Leadership,Schedule Autumn 2023,#{cohort.identifier},true,active,false,false
      CSV
    end
