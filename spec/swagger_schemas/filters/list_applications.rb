LIST_APPLICATIONS_FILTER = {
  v1: {
    ...
    properties: {
      cohort: {
        description: "Return only applications from the specified cohort or cohorts. This is a comma delimited string of years.",
        type: "string",
        example: "2021,2022",
      },
      updated_since: {
      ...
      participant_id: {
        description: "Return only applications from the specified participant or participants. This is comma delimited string of participant IDs.",
        type: "string",
