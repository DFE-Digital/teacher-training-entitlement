PARTICIPANT_DECLARATION = {
  ...
  h[:v1] = h[:v2].deep_dup
  h[:v1][:properties][:attributes][:properties][:statement_id] = {
  ...
  h[:v1][:properties][:attributes][:properties][:clawback_statement_id] = {
  ...
  h[:v1][:properties][:attributes][:properties][:created_at] = {
  ...
  h[:v1][:properties][:attributes][:properties][:delivery_partner_id] = {
  ...
  h[:v1][:properties][:attributes][:properties][:delivery_partner_name] = {
  ...
  h[:v1][:properties][:attributes][:properties][:secondary_delivery_partner_id] = {
  ...
  h[:v1][:properties][:attributes][:properties][:secondary_delivery_partner_name] = {
  ...
  h[:v1][:properties][:attributes][:properties][:application_id] = {
  ...
  updated_at = h[:v1][:properties][:attributes][:properties].delete(:updated_at)
  h[:v1][:properties][:attributes][:properties][:updated_at] = updated_at
}.freeze
