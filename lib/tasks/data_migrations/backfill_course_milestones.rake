  ...
  task :backfill_course_milestones, %i[dry_run] => :environment do |_task, args|
    ...
    CourseCohort.includes(:course).find_each do |course_cohort|
      ...
      legacy_milestones.each do |legacy_milestone|
        start_offset = (legacy_milestone.acceptance_window_start_date - training_starts_at).to_i if legacy_milestone.acceptance_window_start_date
        end_offset = (legacy_milestone.acceptance_window_end_date - training_starts_at).to_i if legacy_milestone.acceptance_window_end_date
