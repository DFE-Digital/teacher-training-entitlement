...
Successful requests will return a response body including updates to the `status` attribute, and a withdrawal `date` reflecting the time the provider submitted the withdrawal API request.
