class Admin::DeliveryPartnersController < AdminController
...
private
  ...
  def set_similarly_named_delivery_partners
    @similarly_named_delivery_partners = if params.dig(:delivery_partner, :name).blank?
                                           []
                                         else
                                           DeliveryPartner.name_similar_to(params.dig(:delivery_partner, :name)).where.not(id: @delivery_partner&.id)
                                         end
  end
