module APITests
  ...
  private
    ...
    def declaration_date
      ...
      if milestone&.acceptance_window_end_date && milestone.acceptance_window_end_date < Time.zone.now
        milestone.acceptance_window_end_date.in_time_zone("UTC").iso8601
      else
