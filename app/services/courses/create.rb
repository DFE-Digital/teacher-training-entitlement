module Courses
  ...
  private
    ...
    def create_milestones!
      state_store.milestone_types.each do |declaration_type|
        course.milestones.find_or_create_by!(declaration_type:) do |milestone|
          milestone.acceptance_window_start_date = Time.zone.today
        end
      end
    end
